          ...
          <div className="mb-6 pb-6 border-b border-[#E5E9F0]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  <select className="h-[50px] border border-[#E5E9F0] rounded px-3 text-base text-black w-full pr-10 appearance-none bg-white">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  ...
                  />
                  <Clock className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 pointer-events-none" size={20} />
                </div>
              </div>
              <div className="flex flex-col gap-2">
